...
obniz.onconnect = async function () {
    ...
    document.getElementById("test-button").onclick = async function(){
        ...
        document.getElementById("test-text").innerHTML = "distance " + (distance*0.001).toFixed(numberOfDecimalPlace) + " cm";
    }
    //測定開始
...
//Stein API: https://api.steinhq.com/v1/storages/6118698047873c2b733280d8